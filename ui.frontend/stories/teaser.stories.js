...
export default {
    ...
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['teaser', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/culebra-peak-design-system/teaser/jcr:content/root/container/container/empty";
export const empty = () => ({
