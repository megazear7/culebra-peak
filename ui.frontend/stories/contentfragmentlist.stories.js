...
export default {
    title: 'Components/contentfragmentlist',
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['contentfragmentlist', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/culebra-peak-design-system/contentfragmentlist/jcr:content/root/container/container/empty";
export const empty = () => ({
