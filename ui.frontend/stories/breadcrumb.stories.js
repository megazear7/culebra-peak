...
export default {
    ...
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['breadcrumb', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/culebra-peak-design-system/breadcrumb/jcr:content/root/container/container/empty";
export const empty = () => ({
