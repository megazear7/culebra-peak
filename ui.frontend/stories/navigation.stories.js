...
export default {
    ...
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['navigation', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/culebra-peak-design-system/navigation/jcr:content/root/container/container/empty";
export const empty = () => ({
