...
export default {
    title: 'Components/experiencefragment',
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['experiencefragment', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/culebra-peak-design-system/experiencefragment/jcr:content/root/container/container/empty";
export const empty = () => ({
