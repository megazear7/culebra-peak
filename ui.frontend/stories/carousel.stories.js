...
export default {
    ...
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['carousel', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/culebra-peak-design-system/carousel/jcr:content/root/container/container/empty";
export const empty = () => ({
